...
impl Tool for PatchTool {
    ...
    fn description(&self) -> ToolDescription {
        ToolDescription {
            ...
            description: "Apply a precise SEARCH/REPLACE edit to an existing file. Preferred over write_file for modifying code: provide the exact text to find (search) and its replacement (replace). The search block must match exactly once — otherwise the patch is rejected and nothing is changed. For creating new files or large rewrites, use write_file.".into(),
